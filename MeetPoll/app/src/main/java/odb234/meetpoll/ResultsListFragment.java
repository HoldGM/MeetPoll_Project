...
public class ResultsListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        resultList = (ListView)rootView.findViewById(R.id.results_list);
        ListAdapter la = new ResultListAdapter(getActivity(), ((TabbedSearchResultsActivity)getActivity()).getMapMarkers());
